...
data class GeneralStyle(
    ...
    val candidateViewHeightLand: Int = 0,
    ...
    val hilitedCandidatePadding: Float = -1f,
    ...
    val keyboardCornerRadius: Float = 0f,
    ...
    companion object {
        fun decode(node: Node): GeneralStyle = GeneralStyle(
            ...
            keyboardCornerRadius = node["keyboard_corner_radius"]?.float ?: 0f,
